...
figma.ui.onmessage = async (msg) => {
  ...
  if (msg.type === 'connected') {
    figma.notify('Figma Agent CLI connected', { timeout: 2000 });
  }

  if (msg.type === 'disconnected') {
    figma.notify('Figma Agent CLI disconnected', { timeout: 2000 });
  }

  if (msg.type === 'error') {
    figma.notify('Figma Agent CLI: ' + msg.message, { error: true });
  }
};
...
console.log('Figma Agent CLI plugin started');
