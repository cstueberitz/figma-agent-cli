...
Repository instructions for working inside this assistant-neutral Figma CLI project.
...
- `fig-start` defaults to Codex today, but the repo is being prepared for multiple assistant adapters.
...
```
Then: Plugins → Development → Figma Agent CLI
